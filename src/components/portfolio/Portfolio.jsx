...
const items = [
  {
    ...
    desc: "We've built a simple CLI speech-to-text tool. Initially, we used the COVID-19 API due to the availability of free API keys, but it works for any speech input, converting it into text effortlessly. ",
    link: "https://github.com/tmanas06/speech", // Example link, replace with actual project URL
  },
  {
    id: 2,
    ...
    desc: "An ecommerce application built with python",
    link: "https://github.com/tmanas06/ShopNest_Hackthon",
  },
  {
    id: 3,
    ...
    desc: "weather application on cli and web",
    link:""
  },
  {
    id: 4,
    ...
    desc: "Static image application in flutter",
    link:"https://github.com/tmanas06/flutter_application_1"
  },
  {
    id: 5,
    ...
    desc: "space-themed music player website with an integrated chat feature and custom themes.",
    link:"https://github.com/tmanas06/Steller-Society"
  },
  {
    id: 6,
  ...
  },
  {
    ...
    desc: "A blog",
    link:"https://techieresearch.blogspot.com/2024/05/deep-dive-into-cosmwasm-contract.html"
  },
  {
    id: 8,
    ...
    desc: "A blog",
    link:"https://techieresearch.blogspot.com/2024/05/oraichain-architecture.html"
  },
];
